...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        with open('exported_data.json', 'w') as f:
            json.dump(data['users'] + data['strains'] + data['subjects'] + data['protocols'] + data['experiments'] + data['files'], f, indent=4)

        self.stdout.write(self.style.SUCCESS("Data exported successfully to 'exported_data.json'."))